...
public class UI {
    ...
    public void drawOptionsScreen() {
        ...
        switch (subState) {
            ...
            case 2: options_constrol(frameX, frameY); break;
            case 3: options_endGameComfirmation(frameX, frameY); break;
        }
    ...
    public void options_constrol(int frameX, int frameY) {
        ...
        g2.drawString("Charachter Screen", textX, textY); textY += gp.tileSize;
